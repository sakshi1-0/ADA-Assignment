21. Implement the Huffman coding algorithm to compress a given string in C or Python.
...
// Create a new Min Heap of given capacity
...
// Build a Huffman tree and return root node
